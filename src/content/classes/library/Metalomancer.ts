...
import { SpellIronGolemInvocation, SpellScrewSplinters, Spell } from "@game/content/spells";
...
export class ClassMetalomancer extends Class {
    ...
    public initialSpells: Spell[] = [new SpellIronGolemInvocation(), new SpellScrewSplinters()];
    public spells: Spell[][] = [];
    public skills: Skill[][] = [];
}